...
$user->company = isset($_GET['business_name']) ? $_GET['business_name'] : die();
...
if($num>0){
    ...
    // products array
    $users_arr=array();
    $users_arr["Client_by_Business_Name"]=array();
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($users_arr["Client_by_Business_Name"], $user_item);
    }
  ...
  echo json_encode($users_arr);
    ...
    echo json_encode(
        array("message" => "No Business Name found.")
    );
}
